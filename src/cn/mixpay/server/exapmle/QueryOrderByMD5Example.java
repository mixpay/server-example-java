 ...
 * 查询订单信息示例
 */
public class QueryOrderByMD5Example {

    public static void main(String [] args) {
        Long mixpayOrderId = new Long("140713000685555335");
        String orderInfoString = OrderTool.queryOrderByMD5Sign(MerchantConfig.APP_KEY, mixpayOrderId, MerchantConfig.SECRET_KEY, false);
